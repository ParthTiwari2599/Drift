...
export default function RoomPage() {
  ...
  return (
    <>
      ...
      <div
        className={`min-h-screen h-[100dvh] w-full ${
          theme === "dark" ? "bg-[#050505] text-zinc-300" : "bg-gray-100 text-gray-800"
        } overflow-hidden`}
      >
        <div
          className={`flex h-full max-w-[1200px] mx-auto ${
            theme === "dark" ? "bg-[#050505]" : "bg-gray-100"
          } overflow-hidden`}
        >
          {/* SIDEBAR */}
          <aside
            className={`hidden sm:flex flex-shrink-0 w-72 xl:w-80 ${
              theme === "dark" ? "bg-black/40 border-zinc-800/50" : "bg-white/80 border-gray-300/50"
          ...
          >
            ...
            <div className="flex-1 overflow-y-auto px-3 xl:px-4 py-4 xl:py-6 space-y-6 custom-scrollbar">
              ...
              <section>
                ...
                <div
                  ...
                  className={`group flex items-center justify-between p-3 xl:p-4 rounded-2xl cursor-pointer transition-all mb-2 border ${
                    currentChat === "group"
                ...
                {privateRooms.map((room) => {
                  ...
                  return (
                    <div
                      ...
                      className={`flex items-center gap-3 p-3 xl:p-4 rounded-2xl cursor-pointer transition-all mb-2 border ${
                        currentChat === room.id
                      ...
                      <div className="flex flex-col">
                        <span
                          className={`text-xs font-black tracking-tight ${
                            u.userId === user.uid ? "text-blue-500" : "text-zinc-400"
                          }`}
                        >
                          {u.userId === user.uid
                            ? "YOU (HOST)"
            ...
            <header className="h-16 sm:h-20 border-b border-zinc-900 flex items-center px-3 sm:px-6 lg:px-10 justify-between bg-black/20 backdrop-blur-md z-20">
              ...
              <div className="flex items-center -space-x-2 sm:-space-x-2">
                ...
                <button
                  ...
                  className={`ml-1 sm:ml-2 w-7 h-7 sm:w-8 sm:h-8 rounded-full border-2 flex items-center justify-center transition-all ${
                    encryptionEnabled
                  ...
                  return (
                    ...
                    >
                      <div className="group relative max-w-[85%] sm:max-w-[70%] lg:max-w-[60%] transition-all">
                          ...
                          <div className="flex items-center gap-2 mb-2 ml-1">
                            <img
                              src={
                                ...
                                generateRandomAvatar(msg.userId)
                              }
                              alt="Avatar"
                        ...
                        <div
                          className={`px-4 sm:px-5 lg:px-6 py-3 sm:py-4 rounded-3xl text-[13px] sm:text-[14px] font-medium leading-relaxed shadow-sm transition-all ${
                            isMe
                        ...
                        <div
                          className={`mt-1 sm:mt-2 flex items-center gap-2 opacity-100 sm:opacity-0 sm:group-hover:opacity-100 transition-all duration-300 ${
                        ...
                        {isMe && (
                          <div className="flex items-center justify-end gap-1 sm:gap-2 mt-1 sm:mt-2 mr-1">
                            ...
                            <img
                              ...
                              alt="Your Avatar"
                              className="w-5 h-5 sm:w-6 sm:h-6 rounded-full border border-zinc-600"
                            />
                          </div>
                        )}
                        ...
                        {msg.reactions && Object.keys(msg.reactions).length > 0 && (
                          <div
                            className={`mt-1 sm:mt-2 flex flex-wrap gap-1 ${
                              isMe ? "justify-end" : "justify-start"
                            }`}
                          >
                            {Object.entries(msg.reactions).map(
                              ([emoji, users]: [string, any]) => (
                                <button
                                  ...
                                  className={`flex items-center gap-1 px-2 py-1 rounded-full text-[10px] sm:text-xs border transition-all ${
                        ...
                        <div
                          className={`mt-1 opacity-100 sm:opacity-0 sm:group-hover:opacity-100 transition-opacity ${
          ...
          >
            ...
            />
            <div
              className={`absolute right-0 top-0 h-full w-72 bg-[#050505] border-l border-white/10 transform transition-transform duration-300 ease-in-out ${
