...
export default function Home() {
  ...
  const generateAvatarFromName = (name: string) => {
    ...
    return `https://ui-avatars.com/api/?name=${encodeURIComponent(name)}&background=${colors[colorIndex].replace('#', '')}&color=fff&size=128`;
  };
    ...
    <main className={`min-h-screen bg-[#050505] text-white selection:bg-blue-500/30 ${isMobileMenuOpen ? 'overflow-hidden' : ''}`}>
      ...
      <div className="relative border-b border-white/5">
        ...
        <nav className="relative z-10 flex justify-between items-center px-4 sm:px-6 py-6 max-w-7xl mx-auto">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xl sm:text-2xl font-black italic tracking-tighter">DRIFT.</span>
          </div>
               ...
               <div className="space-y-4 sm:space-y-6">
                  ...
                  <div className="flex items-center gap-3">
                    <label className="flex items-center gap-2 cursor-pointer">
                      ...
                      />
                      <span className="text-xs sm:text-sm text-zinc-400 font-medium">Make room password protected</span>
                    </label>
                  </div>
                  ...
                  <button onClick={createRoom} className="w-full bg-white text-black py-4 sm:py-5 rounded-2xl font-black uppercase tracking-widest text-xs sm:text-sm hover:bg-blue-600 hover:text-white transition-all">
      ...
      <section id="active-rooms" className="max-w-7xl mx-auto px-4 sm:px-6 py-16 sm:py-32">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            {activeRooms.map(room => (
                <div key={room.id} onClick={() => joinRoom(room)} className="group bg-zinc-900/20 border border-white/5 p-6 sm:p-8 rounded-[2rem] sm:rounded-[2.5rem] cursor-pointer hover:border-blue-500/50 transition-all">
      ...
      <section className="bg-white/5 py-16 sm:py-32 border-y border-white/5">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 grid md:grid-cols-2 gap-10 sm:gap-20 items-center">
            ...
            <div className="space-y-6 sm:space-y-8 order-1 md:order-2">
                <h2 className="text-4xl sm:text-5xl font-black italic tracking-tighter">BUILT FOR <br/> SILENCE.</h2>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 py-16 sm:py-32 space-y-12 sm:space-y-20">
         <div className="text-center space-y-3 sm:space-y-4">
            <h2 className="text-4xl sm:text-6xl font-black italic tracking-tighter">PROTOCOL PHASES</h2>
         ...
         <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
            {[
                ...
                <div key={i} className="p-6 sm:p-10 border border-white/5 rounded-2xl sm:rounded-3xl space-y-4 sm:space-y-6 hover:bg-zinc-900/40 transition-all">
                    <span className="text-3xl sm:text-4xl font-black text-blue-500 opacity-20">{item.step}</span>
                    <h3 className="text-lg sm:text-xl font-black italic tracking-tight">{item.title}</h3>
                    <p className="text-xs sm:text-sm text-zinc-500 leading-relaxed font-medium">{item.desc}</p>
                </div>
            ))}
         </div>
      </section>
      ...
      <footer className="max-w-7xl mx-auto px-4 sm:px-6 py-12 sm:py-20 border-t border-white/5 flex flex-col gap-8 sm:gap-12">
         <div className="flex flex-col sm:flex-row justify-between items-center gap-6 sm:gap-8">
            <div className="flex items-center gap-2 opacity-50">
               ...
               <span className="font-black italic tracking-tighter text-lg sm:text-xl">DRIFT. v2.0</span>
            </div>
            
            {/* Contact Information */}
            <div className="text-center space-y-2 order-3 sm:order-2">
               <div className="text-[9px] sm:text-[10px] font-black uppercase tracking-[0.4em] text-zinc-700">DEVELOPED BY</div>
               <div className="text-sm sm:text-base font-bold text-blue-400">Parth Tiwari</div>
               <div className="text-[8px] sm:text-[9px] text-zinc-500 font-medium">GitHub: @parthtiwari2599</div>
               <div className="text-[8px] sm:text-[9px] text-zinc-500 font-medium">Email: parthtiwari2599@gmail.com</div>
               <div className="text-[7px] sm:text-[8px] text-zinc-600 font-black uppercase tracking-widest mt-2">Suggestions & Contributions Welcome</div>
            </div>
